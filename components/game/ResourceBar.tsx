  ...
  return (
    <div className="flex items-center gap-5 mb-4 px-1 flex-wrap">
      ...
      <div className="flex items-center gap-2 min-w-[180px] flex-1 max-w-xs">
        <span className="text-[11px] text-[#E8A84E] whitespace-nowrap">气血</span>
        ...
        <span className="text-[11px] text-[#8B7A5E] whitespace-nowrap">
      ...
      {/* 修为 */}
      <div className="flex items-center gap-2 min-w-[180px] flex-1 max-w-xs">
        <span className="text-[11px] text-[#C9A04E] whitespace-nowrap">修为</span>
        <div className="progress-bar-track flex-1">
      ...
      {/* 灵石 */}
      <div className="flex items-center gap-1.5 text-xs text-[#4EC9C9]">
        <span>💎</span>
        <span>{player.lingShi}</span>
      </div>

      <div className="text-[11px] text-[#8B7A5E]/60">

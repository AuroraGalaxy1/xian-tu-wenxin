...
export const loreData: Record<string, LoreEntry> = {
  ...
  world_xiu_xing: {
    ...
    title: '灵气与修行',
    content:
      '修行，即是以己身契合天地灵气。感气采气入体为通脉，通脉凝精为凝液，此后玉府、婴胎、神游，直至炼神、开界、合道、历劫、忘机、超脱，步步皆与天争。道心定内，灵蕴养外，体魄为基，神识为眼，因果为绳，执念为障。',
  ...
  world_tian_jie: {
    ...
    title: '天劫',
    content:
      '修士夺天地造化，修行至深必引天妒。天劫降世，雷火交加，渡得过则脱胎换骨，渡不过则灰飞烟灭。历劫一境，是无数修士一生仰望又畏惧的终点——而再往上，便是超脱。',
  ...
  figure_cang_wu: {
    ...
    title: '苍梧药老',
    content:
      '溪风镇丹药铺的掌柜，凝液修士。早年曾是青阳宗外门丹师，因触犯门规被逐出宗门，便在此开了一间药铺。炼丹之术颇精，只是从不提当年旧事。',
  ...
  figure_mo_tie: {
    ...
    title: '墨铁匠',
    content:
      '溪风镇铁匠铺的掌柜，通脉修士，一手锻造功夫在落星坡数一数二。两个徒弟前些年被断魂崖的黑风妖所伤，至今卧床不起。他对黑风妖恨之入骨，悬赏从未撤下。',
  ...
  secret_mi_jing: {
    ...
    title: '秘境入口',
    content:
      '落星坡东北的山崖裂口，是古星陨落时遗下的秘境入口。崖壁刻满古老禁制，灵气自裂隙中如雾涌出。青阳宗封锁此地多年，传言秘境深处藏有古星的核心遗物，非玉府境不可入。',
  ...
  figure_lin_xiu: {
    ...
    title: '林清修',
    content:
      '落星坡一带有名的散修，为人热忱，常替初入修行的年轻人指点迷津。境界虽只有通脉，但在散修盟里颇有声望，是溪风镇的消息通。他手中有一份落星坡的旧地图，标注着几处古星残力异常之地——这地图，是从废宅修士的遗物中辗转得来的。',
  ...
  figure_liu_qing: {
    ...
    title: '柳青',
    content:
      '青阳宗分坛执事，剑修，玉府初境。为人刻板守规，对宗门忠心耿耿，负责镇守落星坡秘境入口。她深知秘境的秘密，但从不对外人多言——青阳宗对秘境的研究，远比表面上看到的要深。',
